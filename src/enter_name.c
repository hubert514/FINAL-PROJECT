...
int main(int argc, char *argv[]) {
    ...
    TTF_Font *font = TTF_OpenFont("/mnt/c/Users/user/Desktop/homework/FINAL-PROJECT/assets/fonts/kaiu.ttf", 45); // Use a valid path to a .ttf file
    if (!font) {
    ...
    while (!quit) {
        ...
        if (strlen(playerName) == 0) {
            show_image(renderer, "/mnt/c/Users/user/Desktop/homework/FINAL-PROJECT/assets/images/entername.png", 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT);
